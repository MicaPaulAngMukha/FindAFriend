...
1. Users: Stores credentials, bios, and profile pictures (as Blobs).
2. Interests: Relates users to their chosen hobbies with cascading deletes.
3. Messages: Handles the sender/receiver relationships and timestamps.
4. Archived Chats: Tracks which conversations are hidden from the main feed.
5. Blocked Users: A many-to-many table that filters the global user pool for discovery.
...
4. Ensure you have the required icons in the res/drawable folder (e.g., icons8_arts, icons8_hide, etc.).

5. Run the app on an emulator or physical device.

_Feel free to use it for school projects_

_Created with ❤️ for social connection._
